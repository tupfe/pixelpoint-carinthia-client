...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><header style="${ssrRenderStyle({ "padding": "1rem", "border-bottom": "1px solid #ddd" })}"><h1>Carinthia Client</h1></header><main style="${ssrRenderStyle({ "padding": "1rem" })}">`);
